...
NALParser::NALParser(JNIEnv *env, jobject udpManager, UdpManager *udpManager_C) : m_queue(udpManager_C) {
    ...
    jclass NAL_clazz = env->FindClass("com/softnautics/snvr/NAL");
    ...
    jclass udpManagerClazz = env->FindClass("com/softnautics/snvr/UdpReceiverThread");
    mObtainNALMethodID = env->GetMethodID(udpManagerClazz, "obtainNAL", "(I)Lcom/softnautics/snvr/NAL;");
    mPushNALMethodID = env->GetMethodID(udpManagerClazz, "pushNAL", "(Lcom/softnautics/snvr/NAL;)V");
