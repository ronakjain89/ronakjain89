...
Java_com_softnautics_snvr_GvrRenderer_createNative(JNIEnv *env, jobject gvrRenderer, jobject assetManager) {
...
Java_com_softnautics_snvr_GvrRenderer_glInitNative(JNIEnv *env, jobject gvrRenderer, jlong instance, jint width, jint height) {
    ((GvrRenderer *) instance)->glInit(env, width, height);
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_softnautics_snvr_GvrRenderer_getLoadingTexture(JNIEnv *env, jobject gvrRenderer, jlong instance) {
    return ((GvrRenderer *) instance)->getLoadingTexture();
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_softnautics_snvr_GvrRenderer_getSurfaceTexture(JNIEnv *env, jobject instance,
                                                         jlong nativeHandle) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_softnautics_snvr_GvrRenderer_renderNative(JNIEnv *env, jobject gvrRenderer,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_softnautics_snvr_GvrRenderer_destroyNative(JNIEnv *env, jobject gvrRenderer, jlong instance) {
