...
void GvrTracking::initialize(JNIEnv *env, jlong nativeGvrContext) {
    ...
    jclass clazz = env->FindClass("com/softnautics/snvr/UdpReceiverThread");
...
Java_com_softnautics_snvr_GvrTracking_initializeNative(JNIEnv *env, jobject instance, jlong nativeGvrContext) {
...
Java_com_softnautics_snvr_GvrTracking_sendTrackingInfoNative(JNIEnv *env, jobject instance,
