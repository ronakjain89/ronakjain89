...
Java_com_softnautics_snvr_LatencyCollector_DecoderInput(JNIEnv *env, jclass type,
                                                         jlong frameIndex) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_softnautics_snvr_LatencyCollector_DecoderOutput(JNIEnv *env, jclass type,
                                                          jlong frameIndex) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_softnautics_snvr_LatencyCollector_Submit(JNIEnv *env, jclass type, jlong frameIndex) {
