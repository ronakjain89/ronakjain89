...
Java_com_softnautics_snvr_UdpReceiverThread_initializeSocket(
...
Java_com_softnautics_snvr_UdpReceiverThread_closeSocket(JNIEnv *env, jobject instance, jlong nativeHandle) {
    delete reinterpret_cast<UdpManager *>(nativeHandle);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_softnautics_snvr_UdpReceiverThread_runLoop(JNIEnv *env, jobject instance, jlong nativeHandle,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_softnautics_snvr_UdpReceiverThread_interruptNative(JNIEnv *env, jobject instance, jlong nativeHandle) {
    reinterpret_cast<UdpManager *>(nativeHandle)->interrupt();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_softnautics_snvr_UdpReceiverThread_isConnectedNative(JNIEnv *env, jobject instance, jlong nativeHandle) {
    return nativeHandle != 0 && reinterpret_cast<UdpManager *>(nativeHandle)->isConnected();
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_softnautics_snvr_UdpReceiverThread_getServerAddress(JNIEnv *env, jobject instance, jlong nativeHandle) {
    return reinterpret_cast<UdpManager *>(nativeHandle)->getServerAddress(env);
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_softnautics_snvr_UdpReceiverThread_getServerPort(JNIEnv *env, jobject instance, jlong nativeHandle) {
    return reinterpret_cast<UdpManager *>(nativeHandle)->getServerPort();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_softnautics_snvr_UdpReceiverThread_sendNative(JNIEnv *env, jobject instance,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_softnautics_snvr_UdpReceiverThread_setSinkPreparedNative(JNIEnv *env, jobject instance, jlong nativeHandle, jboolean prepared) {
