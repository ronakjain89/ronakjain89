...
public class LauncherSocket {
        ...
        try {
            AsyncServer.getDefault().listen(InetAddress.getByName("0.0.0.0"), 9944, new ListenCallback() {
                ...
                public void onListening(AsyncServerSocket socket) {
                    ...
                    Utils.logi(TAG, () -> "on listening in launchersocket.java");
                }
    ...
    public void send(Command command) {
        ...
        Utils.logi(TAG, () -> "in send function in launchersocket.java");
        ...
        Utils.logi(TAG, () -> "byteBufferlist" + byteBufferList);
    }
    ...
    private void onDataAvailable(DataEmitter emitter, ByteBufferList bb) {
        ...
        while (bb.remaining() > 0) {
            if (mReadState == 0) {
                ...
                Utils.logi(TAG, () -> "in onDataAvailable callback " );
                mReadState = 1;
                ...
                Utils.logi(TAG, () -> "printing bytebuffer list" + bb  );
                onReceive();
