...
public class surfacecontext {
   ...
   private long handle;
    public void initialize(Activity activity, AssetManager assetManager, Runnable ovrThread, boolean ARMode, int initialRefreshRate) {
        handle = initializeNative(activity, assetManager, (MainThread) ovrThread, ARMode, initialRefreshRate);
    }
    ...
    private native long initializeNative(Activity activity, AssetManager assetManager, MainThread ovrThread, boolean ARMode, int initialRefreshRate);
